...
import com.cy.platform.generation.server.core.FileTemplateEngine;
import com.cy.platform.generation.server.core.JdbcToJavaHelper;
import com.cy.platform.generation.server.core.TemplateEngine;
import com.cy.platform.generation.server.core.model.TableInfo;
import com.cy.platform.generation.server.domain.mapper.DataSourceMapper;
import com.cy.platform.generation.server.domain.mapperx.BaseGeneratorMapper;
import com.cy.platform.generation.server.domain.mapperx.MySqlGeneratorMapper;
import com.cy.platform.generation.server.domain.mapperx.SqlServerGeneratorMapper;
            ...
            try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
                ...
                switch (vo.getDbType()) {
                    case MYSQL:
                        ...
                        break;
                    case SQLSERVER:
                        throw new UnsupportedOperationException("目前不支持Sql Server");
                    default:
